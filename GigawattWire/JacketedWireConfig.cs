...
namespace Egladil
{
    public class JacketedWireConfig : BaseWireConfig
    {
        ...
        {
            BuildingDef buildingDef = CreateBuildingDef(ID, "utilities_electric_conduct_kanim", 3f, ExtendedWire.INSULATED_WIRE_MASS_KG, 0.05f, noise: TUNING.NOISE_POLLUTION.NONE, decor: TUNING.BUILDINGS.DECOR.NONE);
